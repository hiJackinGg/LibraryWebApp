...
public class LibraryDaoTest {
    ...
    @Test
    public  void testFindAllBooks3() throws SQLException {
    ...
    public  void testFindAllBooks33() throws SQLException {
        libraryDAO.getAllBooks(-1, 3, "title", true).getBooks();
    }

    @Test(expected = IllegalArgumentException.class)
    public  void testFindAllBooks331() throws SQLException {
        libraryDAO.getAllBooks(0, 0, "title", true).getBooks();
    }

    @Test(expected = IllegalArgumentException.class)
    public  void testFindAllBooks333() throws SQLException {
        List<Book> actualBooks1 = libraryDAO.getAllBooks(0, 3, "price", true).getBooks();
    }

    @Test
    public  void testFindAllBooks3333() throws SQLException {
    ...
    @Test
    public  void testFindAllBooks33333() throws SQLException {
     ...
     */
    @Test
    public  void testFindAvailableBooks10() throws SQLException {
...
//        expectedBooksUserSortedByTitle.sort((b1, b2) -> b1.getTitle().compareTo(b2.getTitle()));
     ...
     */
    @Test
    public  void testFindAvailableBooks11() throws SQLException {
     ...
     */
    @Test
    public  void testFindAvailableBooks12() throws SQLException {
     ...
     */
    @Test
    public  void testFindAvailableBooks13() throws SQLException {
     ...
     */
    @Test
    public  void testFindAvailableBooks14() throws SQLException {
        ...
        List<AbstractMap.SimpleEntry<String, String>> actualDetails = libraryDAO.getBookDetails(1);
     ...
     */
    @Test
    public  void testFindAvailableBooks15() throws SQLException {

        int actualQty1 = libraryDAO.getBookQuantity(1);
        int actualQty2 = libraryDAO.getBookQuantity(3);
        assertEquals(0, actualQty1);
        assertEquals(2, actualQty2);
    }
     ...
     */
    @Test
    public  void testFindAvailableBooks16() throws SQLException {
        ...
        newTestBook.setAuthors(Arrays.asList("testAuthor"));

        List<Book> allBooksWithNewInserted = libraryDAO.getAllBooks(0, expectedBooksAllSortedByTitle.size() + 1, "title", true).getBooks();

        assertTrue(allBooksWithNewInserted.contains(newTestBook));
        assertEquals(expectedBooksAllSortedByTitle.size() + 1, allBooksWithNewInserted.size());
     ...
     */
    @Test
    public  void testFindAvailableBooks17() throws SQLException {
        ...
        assertFalse(allBooksWithNewInserted.contains(newTestBook));
        assertEquals(expectedBooksAllSortedByTitle.size(), allBooksWithNewInserted.size());
     ...
     */
    @Test
    public  void testFindAvailableBooks18() throws SQLException {
     ...
     */
    @Test(expected = IllegalArgumentException.class)
    public  void testFindAvailableBooks19() throws SQLException {
     ...
     */
    @Test
    public  void testFindAvailableBooks20() throws SQLException {
    ...
    public  void testFindAvailableBooks21() throws SQLException {
